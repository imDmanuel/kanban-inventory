    ...
    >
      ...
      <p
        className={cx(
          ...
          hasOnValueChange &&
            "group-hover:text-grey-900 -dark:group-hover:text-grey-50",
          activeLegend && activeLegend !== name ? "opacity-40" : "opacity-100"
        )}
      >
        {name}
    ...
    <button
      ...
      className={cx(
        ...
        disabled
          ...
          : "cursor-pointer text-grey-700 hover:bg-grey-100 hover:text-grey-900 -dark:text-grey-300 -dark:hover:bg-grey-800 -dark:hover:text-grey-50"
      )}
      disabled={disabled}
      onClick={(e) => {
        e.stopPropagation();
      ...
      <div ref={ref} className={cx("h-80 w-full", className)} {...other}>
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx("stroke-grey-200 stroke-1 -dark:stroke-grey-800")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
            <XAxis
              ...
              className={cx(
                ...
                "text-xs",
                // text fill
                "fill-grey-500 -dark:fill-grey-500"
              )}
              tickLine={false}
              axisLine={false}
              minTickGap={tickGap}
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-grey-800 text-sm font-medium -dark:fill-grey-200"
                >
                  {xAxisLabel}
                </Label>
              )}
              ...
              <Area
                ...
                activeDot={(props: any) => {
                  ...
                  return (
                    <Dot
                      className={cx(
                        "stroke-white -dark:stroke-grey-950",
